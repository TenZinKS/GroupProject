...
frame_wtht=Frame(root,bg="white",pady=50, padx=150)
frame_wtht.place(x=200,y=200)

# TEXT / QUESTIONS
title = Label(title_frame, text="BMI CALCULATOR", font=("Lexend", 36, "bold", "underline"), bg="white", fg="black")
title.pack(padx=10, pady=5)
ask_weight=Label(frame_wtht,text="Enter your weight(in kg): ",bg="white",fg="black",padx=20)
ask_weight.grid(row=0, column=1, pady=70)
ask_height=Label(frame_wtht,text="Enter your height(in cm): ",bg="white",fg="black",padx=20)
...
weight_entry.grid(row=0, column=4, ipady=5, padx=30)

height_entry=Entry(frame_wtht)
height_entry.insert(INSERT, "height")
height_entry.grid(row=1, column=4, ipady=5, padx=30)
