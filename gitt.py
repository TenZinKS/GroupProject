...
text_2 = Label( text="tenzinkuenzel2016@gmail.com ", font=("Arial", 20), bg="white", fg="black")
...
text_2 = Label( text="dhakalabhinav4@gmail.com ", font=("Arial", 20 ), bg="white", fg="black")
...
text_2 = Label( text="aayambhattarai3@gmail.com ", font=("Arial", 20), bg="white", fg="black")
...
text_2 = Label( text="soyeshxrestha@gmail.com ", font=("Arial", 20), bg="white", fg="black")
text_2.grid(padx=260,row=9, column=0, sticky="w")

img = Image.open("logo_slogan.png")
resized = img.resize((500,200),Image.LANCZOS)
